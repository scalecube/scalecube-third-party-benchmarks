...
import io.scalecube.benchmarks.storages.chronicle.marshallers.OrderMarshaller;
import io.scalecube.benchmarks.storages.chronicle.marshallers.UuidMarshaller;
...
public class ChronicleMapStorage implements Storage<UUID, Order> {
  ...
  ChronicleMapStorage(BenchmarkSettings settings) {
    ...
    try {
      ...
      chronicleMap =
          ChronicleMap.of(UUID.class, Order.class)
              ...
              .valueMarshaller(new OrderMarshaller())
